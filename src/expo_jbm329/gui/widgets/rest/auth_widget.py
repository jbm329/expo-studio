...
class RestAuthWidget(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self.auth_combo.addItem(self.tr("Bearer"), userData="bearer")
        ...
        self.refresh_token_edit.setPlaceholderText(self.tr("paste refresh token"))

        self.form_layout = QFormLayout(self)
        self.form_layout.setContentsMargins(0, 0, 0, 0)
        self.form_layout.addRow(self.tr("Type:"), self.auth_combo)
        self.form_layout.addRow(self.tr("Bearer token"), self.token_edit)
        self.form_layout.addRow(self.tr("Basic username"), self.username_edit)
        self.form_layout.addRow(self.tr("Basic password"), self.password_edit)
        self.form_layout.addRow(self.tr("API key name"), self.api_key_name_edit)
        self.form_layout.addRow(self.tr("API key value"), self.api_key_value_edit)
        self.form_layout.addRow(self.tr("API key location"), self.api_key_location_combo)
        self.form_layout.addRow(self.tr("OAuth2 token URL"), self.token_url_edit)
        self.form_layout.addRow(self.tr("OAuth2 client ID"), self.client_id_edit)
        self.form_layout.addRow(self.tr("OAuth2 client secret"), self.client_secret_edit)
        self.form_layout.addRow(self.tr("OAuth2 grant type"), self.grant_type_combo)
        self.form_layout.addRow(self.tr("OAuth2 scope"), self.scope_edit)
        self.form_layout.addRow(self.tr("OAuth2 refresh token"), self.refresh_token_edit)
